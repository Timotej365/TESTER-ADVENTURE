...
# Pridáme cestu do adresára, kde máme hru
sys.path.append('C:/Users/timot/Desktop/subory do portfolia/tester adventure')


# Importujeme funkciu zo súboru s hrou
from tester_adventure import hadanka_otazka
...
class TestHadankaOtazka(unittest.TestCase):
    ...
    def test_spravna_odpoved(self, mock_input, mock_random_choice):
        ...
        mock_random_choice.return_value = {"otazka": "Aký typ testovania vykonáva používateľ? (funkcne, regresne, acceptance)", "odpoved": "akceptacne"}
    ...
    @patch('random.choice')  # Mockujeme random.choice
    @patch('builtins.input')  # Mockujeme input
